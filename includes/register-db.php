 ...
 if(!$sql_rgst) {
   if(mysqli_error($sql_conn)=="Duplicate entry 'test1' for key 'PRIMARY'") {
   ...
   <p class='w3-large' style='text-align: center;'>Please Contact Administrator/Data Base Administrator to activate/verify your Account.</p>";
 }
