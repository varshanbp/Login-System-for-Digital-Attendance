  ...
  <nav class="w3-topnav w3-green">
    ...
    <div class="w3-dropdown-hover">
      ...
      <div class="w3-dropdown-content w3-card-4">
        <a href="#" style="color:black;" onclick="document.getElementById('id02').style.display='block'">Add New Student</a>
        <a href="#" style="color:black;">Edit Student Details</a>
        <a href="#" style="color:black;">List Students</a>
      </div>
    </div>
    <div class="w3-dropdown-hover">
    ...
    <div class="w3-dropdown-hover">
      ...
      <div class="w3-dropdown-content w3-card-4">
        <a href="#" style="color:black;">Mark Today's Attendance</a>
...
<div class="w3-btn-group w3-padding-32">
<iframe class="w3-container w3-border" id="if1" style="width:100%;height:100%;"></iframe>
</div>
